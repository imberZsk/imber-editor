...
import { MenuProps } from "@/tiptap/menus/types";
    ...
    >
      <Toolbar.Wrapper shouldShowContent={shouldShow()} ref={menuRef}>
        <Toolbar.Button tooltip="Align image left" active={isImageLeft} onClick={onAlignImageLeft}>
          <AlignHorizontalDistributeStart className="size-4" strokeWidth={2.5} />
        </Toolbar.Button>
        <Toolbar.Button tooltip="Align image center" active={isImageCenter} onClick={onAlignImageCenter}>
          <AlignHorizontalDistributeCenter className="size-4" strokeWidth={2.5} />
        </Toolbar.Button>
        <Toolbar.Button tooltip="Align image right" active={isImageRight} onClick={onAlignImageRight}>
          <AlignHorizontalDistributeEnd className="size-4" strokeWidth={2.5} />
        </Toolbar.Button>
        <Toolbar.Divider />
